...
- (void)windowDidLoad
{
    ...
    [[self autoSnapshots] setState:[[appDelegate preferences] boolForKey:@"autoSnapshotsEnabled"]];
    [self autoSnapshotChanged:nil];
...
-(IBAction) applyChanges:(id)sender {
    ...
    [[appDelegate preferences] setBool:[[self autoSnapshots] state] forKey:@"autoSnapshotsEnabled"];
